...
public class CallFormActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    private static final String TAG = "CallFormActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client = LocationServices.getFusedLocationProviderClient(CallFormActivity.this);
...
//                if (ActivityCompat.checkSelfPermission(CallFormActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(CallFormActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//                    return;
//                }
//                client.getLastLocation().addOnSuccessListener(CallFormActivity.this, new OnSuccessListener<Location>() {
//                    @Override
...
//
//                            if(age.equals("")){
//                                StyleableToast.makeText(CallFormActivity.this, " Enter your age. ",
//                                        Toast.LENGTH_LONG,
...
//                Toast.makeText(CallFormActivity.this,
//                        "name= " + name + "\n" +
//                                "crisis= " + crisis + "\n" +
//                                "age= " + age + "\n" +
//                                "gender= " + gender + "\n" +
...
//        finish();
        ...
        termsCondition.openDialog(CallFormActivity.this);
    ...
    private void showActivityIndicator() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
//                isDialog = true;
                dialog1 = new Dialog(CallFormActivity.this);
                ...
                if (!CallFormActivity.this.isFinishing() && !CallFormActivity.this.isDestroyed()) {
                    dialog1.show();
                }
            }
        });
    ...
    private void spinnerAbout() {
        ...
        spinner_about.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Toast.makeText(CallFormActivity.this, ""+item, Toast.LENGTH_SHORT).show();
            }
...
//            @Override
//            public void run() {
//                progressDialog = new ProgressDialog(CallFormActivity.this);
    ...
    private void hitApi(String user_type,
        ...
        call.enqueue(new Callback<CaseModel>() {
            ...
            public void onResponse(Call<CaseModel> call, Response<CaseModel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().equals("valid")) {
                        ...
                        dialogFragment = CallCaseDialogFragment.newInstance(
                                response.body().getCaseId(),
                                response.body().getVolunteer().getVounterId(),
                                language,viewModel);
                        dialogFragment.show(getSupportFragmentManager(), "Call Case Dialog");

                       /* Intent intent = new Intent(CallFormActivity.this, CallActivity.class);
                        intent.putExtra("caseID", response.body().getCaseId());
                        intent.putExtra("VolID", response.body().getVolunteer().getVounterId());
                        Log.i(TAG, "onResponse: VoldID to :"+response.body().getVolunteer().getVounterId());
                        ...
                        stopActivityIndicator();
                        StyleableToast.makeText(CallFormActivity.this, " " + response.body().getMessage() + " ",
                                Toast.LENGTH_LONG,
                                R.style.mytoast).show();
                    }
                }
            ...
            public void onFailure(Call<CaseModel> call, Throwable t) {
                ...
                StyleableToast.makeText(CallFormActivity.this, " " + t.getMessage() + " ",
                        Toast.LENGTH_LONG,
                        R.style.mytoast).show();
            }
        });
