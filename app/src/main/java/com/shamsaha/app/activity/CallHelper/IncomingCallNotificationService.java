...
import com.shamsaha.app.activity.volunteer.onduty.DutyShiftActivity;
...
public class IncomingCallNotificationService extends Service {
    ...
    private Notification createNotification(CallInvite callInvite, int notificationId, int channelImportance) {
        Intent intent = new Intent(this, DutyShiftActivity.class);
    ...
    private Notification buildNotification(String text, PendingIntent pendingIntent, Bundle extras,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            piRejectIntent = PendingIntent.getService(getApplicationContext(), 0, rejectIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        }else {
    ...
    private void accept(CallInvite callInvite, int notificationId) {
        endForeground();
        Intent activeCallIntent = new Intent(this, DutyShiftActivity.class);
