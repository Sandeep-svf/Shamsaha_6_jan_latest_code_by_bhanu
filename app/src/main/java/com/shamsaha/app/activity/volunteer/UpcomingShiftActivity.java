...
public class UpcomingShiftActivity extends AppCompatActivity
    ...
    ArrayList<UpcomingShift> dataModel = new ArrayList<>();
    private UpcomingShiftAdaptor shiftAdaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upcoming_shift);
...
//        ll_reward = findViewById(R.id.ll_reward);
        ...
        Glide.with(UpcomingShiftActivity.this).load(profile).placeholder(R.drawable.ic_smalllogo).into(navigationView_);
...
//                openBackupDialog();
    ...
    public void openServicesDialog() {
        ...
        if (!UpcomingShiftActivity.this.isFinishing() && !UpcomingShiftActivity.this.isDestroyed()) {
            dialog.show();
        }
    }
    private void openLanguageDialog() {
        ...
        alert = new android.app.AlertDialog.Builder(UpcomingShiftActivity.this);
        final LayoutInflater inflater = LayoutInflater.from(UpcomingShiftActivity.this);
...
//                Toast.makeText(VolunteerHome.this, "supportStr "+ support, Toast.LENGTH_SHORT).show();
            if(support.toString().isEmpty()||support.toString().equals("")||message.getText().toString().isEmpty()||message.getText().toString().equals("")){
                Toast.makeText(UpcomingShiftActivity.this, "Fill the form", Toast.LENGTH_SHORT).show();
            }else {
            ...
            public void onResponse(Call<List<AdditionalLanguageModel>> call, Response<List<AdditionalLanguageModel>> response) {
                if (response.isSuccessful()) {
                    ...
                    for (AdditionalLanguageModel resource_location : resData) {
                        ...
                        ArrayAdapter<AdditionalLanguageSpinnerAdaptor> arrayAdapter = new ArrayAdapter<>(UpcomingShiftActivity.this, android.R.layout.simple_spinner_item, location);
...
//                                        "\nLocation : "+spinnerAdaptor.getLocation(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(UpcomingShiftActivity.this, "Something went wrong (OR) check your internet connection...!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<AdditionalLanguageModel>> call, Throwable t) {
                Toast.makeText(UpcomingShiftActivity.this, "Something went wrong (OR) check your internet connection...!\n"+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onResponse(Call<ChannelListModel> call, Response<ChannelListModel> response) {
                if(response.isSuccessful() && response.code() == 200 && response.body() != null && response.body().getData() != null && response.body().getData().size() > 0){
                    ...
                    for(ChannelListModel.Datum channel: resData){
                        ...
                        ArrayAdapter<CaseIDSpinnerAdaptor> adaptorArrayAdapter = new ArrayAdapter<>(UpcomingShiftActivity.this, android.R.layout.simple_spinner_item, channelData);
    ...
    private void hitSendLanguageRequest(String Language, String caseID, String message,String support) {
        ...
        call.enqueue(new Callback<LanguageRequestModel>() {
            ...
            public void onFailure(Call<LanguageRequestModel> call, Throwable t) {
                ...
                StyleableToast.makeText(UpcomingShiftActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void HitMyShiftApi() {
        ...
        call.enqueue(new Callback<List<UpcomingShift>>() {
            ...
            public void onResponse(Call<List<UpcomingShift>> call, Response<List<UpcomingShift>> response) {
                ...
                shiftAdaptor = new UpcomingShiftAdaptor(dataModel, UpcomingShiftActivity.this);
...
//        setRewards(total_rewards);
    ...
    private void onDuty() {
        Intent intent = new Intent(UpcomingShiftActivity.this, DutyShiftActivity1.class);
