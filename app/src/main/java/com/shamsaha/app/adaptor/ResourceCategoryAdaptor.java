...
import com.shamsaha.app.activity.PublicPart.Resource.ResourceContactsActivity;
...
public class ResourceCategoryAdaptor extends RecyclerView.Adapter<ResourceCategoryAdaptor.ViewHolder> {
    ...
    public ResourceCategoryAdaptor(Context context, ArrayList<ResourceCategory> dataModels) {
    ...
    @NonNull
    @Override
    public ResourceCategoryAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ResourceCategoryAdaptor.ViewHolder holder, final int position) {
        ...
        holder.Rootlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, ResourceContactsActivity.class);
