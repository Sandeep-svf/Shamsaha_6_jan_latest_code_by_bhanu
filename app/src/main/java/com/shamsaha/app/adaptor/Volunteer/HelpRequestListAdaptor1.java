...
public class HelpRequestListAdaptor1 extends RecyclerView.Adapter<HelpRequestListAdaptor1.ViewHolder> {
    ...
    public HelpRequestListAdaptor1(List<HelpRequestModel.Datum> helpRequestModels, Context context, String volID) {
...
//        this.dialog = dialog;
    ...
    @NonNull
    @Override
    public HelpRequestListAdaptor1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HelpRequestListAdaptor1.ViewHolder holder, int position) {
...
//            dialog.dismiss();
            ...
            openHelpListDialog(dialog1,helpRequestModels.get(position).getCaseId(),helpRequestModels.get(position).getMessage(),volID,helpRequestModels.get(position).getId());
        });
    ...
    private void openHelpListDialog(Dialog dialog1,String CaseID,String message, String VolID,String id) {
