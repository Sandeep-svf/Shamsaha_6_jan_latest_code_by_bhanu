...
public class ResourceContactAdaptor extends RecyclerView.Adapter<ResourceContactAdaptor.ViewHolder> {
    ...
    public ResourceContactAdaptor(Context context, ArrayList<resource> dataModels) {
    ...
    @NonNull
    @Override
    public ResourceContactAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.resource_contact_adaptor, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull ResourceContactAdaptor.ViewHolder holder, final int position) {

        //holder.setFixedHeight();
//        Log.d("hold___", "nnn\n" + dataModels.get(position).getEmailInfo());
        holder.Root_layout.setAnimation(AnimationUtils.loadAnimation(context,R.anim.fade_left));
...
//        holder.web_info.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Log.d("hold___", "" + dataModels.get(position).getContactInfo());
//
//                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://"+dataModels.get(position).getWebInfo()));
//                context.startActivity(intent);
//            }
//        });
//
//        holder.email_info.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Log.d("hold___", "" + dataModels.get(position).getContactInfo());
//
//                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
//                        "mailto", dataModels.get(position).getEmailInfo(), null));
//                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Subject");
//                emailIntent.putExtra(Intent.EXTRA_TEXT, "Body");
//                context.startActivity(Intent.createChooser(emailIntent, "Send Email"));
//            }
